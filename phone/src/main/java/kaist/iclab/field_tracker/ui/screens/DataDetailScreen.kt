...
@Composable
fun DataDetailScreen(name: String, permissions: List<String>) {
...
@Composable
fun DataDetailScreenPreview() {
    Column(verticalArrangement = Arrangement.spacedBy(14.dp)) {
        DataDetailScreen("Location", listOf("Location"))
    }
}